...
As shown in the Residuals vs Fitted plot, residual values bounce around 0 and residuals form a generally horizontal 'band' around zero, showing no unequal error variance. According to the QQ plot, which is almost straight, exhibiting a nice normality without heteroscedasticity. The Scale-location plot is almost a horizontal line with equally spread points, confirming the assumption of equal variance. In the Residuals vs Leverage plot, 
