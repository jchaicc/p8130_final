...
## _Model Selection_
The model we obtained by Stepwise Regression is bodyfat_siri = 84.7635 + 1.0080 * age -0.4150 * height + 2212.3159 * i_neck -6835.4225 * i_abdomen + 0.3344 * forearm -1.7566 * wrist -36.2415 * (age*i_neck).
